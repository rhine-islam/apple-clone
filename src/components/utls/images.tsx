const images = {
  ...
  banner1:
    "./assets/images/banner/hero_iphone14pro_spring__9xo85pm6sbmm_largetall.jpg",
  banner2:
    "./assets/images/banner/hero_iphone14_yellow__eun20sn4imi6_largetall.jpg",
  banner3:
    "./assets/images/banner/hero_apple_watch_series_8_spring__b1y8wb7xjc9y_largetall.jpg",
  banner4:
    "./assets/images/banner/iphone_tradein_promo__d5au3rkw5kuq_large.jpg",
  banner5: "./assets/images/banner/promo_homepod__f7jnolq94m2y_large.jpg",
  banner6: "./assets/images/banner/promo_ipad__fioegapg12qi_large.jpg",
