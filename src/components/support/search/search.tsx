        ...
        <div className="md:flex">
          <div className="p-3">
            <div className="relative">
              ...
              <input
                type="text"
                className="bg-white border rounded-lg  h-14 focus:outline-none focus:ring focus:ring-blue-300 hover:cursor-pointer xl:w-[1300px] lg:w-[1000px] px-12 md:w-[800px] w-[350px]"
                name=""
